...
python -m vllm.entrypoints.openai.api_server --model svjack/Genshin_Impact_Mistral_v3_Plot_Chat_roleplay_chat_AWQ --dtype auto \
 --api-key token-abc123 --quantization awq --max-model-len 4000 --gpu-memory-utilization 0.35 --port 8000
...
python -m vllm.entrypoints.openai.api_server --model svjack/DPO_Genshin_Impact_Mistral_Plot_Engine_Step_Json_Short_AWQ --dtype auto \
 --api-key token-abc123 --quantization awq --max-model-len 2000 --gpu-memory-utilization 0.35 --port 8001
'''
...
adapter_name_client_dict = {
    "chat": {
    "model": "svjack/Genshin_Impact_Mistral_v3_Plot_Chat_roleplay_chat_AWQ",
    "client": OpenAI(
        api_key="token-abc123",
        base_url="http://localhost:8000/v1",
    )},
    "engine": {
    "model": "svjack/DPO_Genshin_Impact_Mistral_Plot_Engine_Step_Json_Short_AWQ",
    "client": OpenAI(
        api_key="token-abc123",
...
with gr.Blocks() as demo:
    gr.Markdown("""<center><font size=8>😸 Genshin Impact Mistral-7B-Instruct-v0.3 Plot Roleplay Turned ⚡️ vLLM ⚡️ Bot 🌊</center>""")
    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            chatbot = gr.Chatbot(
                label='svjack/Genshin_Impact_Mistral_v3_Plot_Chat_roleplay_chat_AWQ/DPO_Genshin_Impact_Mistral_Plot_Engine_Step_Json_Short_AWQ',
                height = 768
                )
