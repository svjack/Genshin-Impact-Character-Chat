...
python -m vllm.entrypoints.openai.api_server --model svjack/Genshin_Impact_Qwen_1_5_Chat_sharegpt_roleplay_chat_AWQ --dtype auto \
...
adapter_name_client_dict = {
    "chat": {
    "model": "svjack/Genshin_Impact_Qwen_1_5_Chat_sharegpt_roleplay_chat_AWQ",
    "client": OpenAI(
...
def init_background_chat(single_name_1, single_name_2):
    ...
    req_iter = openai_predict_stream(messages)
...
with gr.Blocks() as demo:
    gr.Markdown("""<center><font size=8>😊 Genshin Impact Qwen-1.5-7B-Chat Sharegpt Roleplay Turned ⚡️ vLLM ⚡️ Bot 🔥</center>""")
    ...
    chatbot = gr.Chatbot(label='svjack/Genshin_Impact_Qwen_1_5_Chat_sharegpt_roleplay_chat_AWQ')
